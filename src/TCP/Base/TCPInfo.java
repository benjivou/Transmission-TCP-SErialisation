...
public class TCPInfo {
   ...
   protected void ssInfo(String event, ServerSocket ss) throws SocketException,IOException {
   ...
   protected void sInfo(String event, Socket s) throws SocketException,IOException {
